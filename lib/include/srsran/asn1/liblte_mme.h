...
#ifndef SRSRAN_LIBLTE_MME_H
#define SRSRAN_LIBLTE_MME_H
...
/*********************************************************************
    Message Name: Tracking Area Update Request [MC define]
    Description: Sent by the UE to the network
