...
public:
  ...
  virtual std::string get_imsi_a_str()                                    = 0;
  virtual std::string get_imei_a_str()                                    = 0;
  virtual std::string get_imsi_tmp_str()                                  = 0;
  virtual uint32_t get_tmsi_tmp()                                  = 0;
  virtual bool        get_imsi_a_vec(uint8_t* imsi_, uint32_t n)          = 0;
  virtual bool        get_imei_a_vec(uint8_t* imei_, uint32_t n)          = 0;
  virtual bool        get_imsi_tmp_vec(uint8_t* imsi_, uint32_t n)          = 0;
  // virtual bool        get_tmsi_tmp_vec(uint8_t* guti_, uint32_t n)          = 0;
