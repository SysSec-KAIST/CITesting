...
*********************************************************************/
LIBLTE_ERROR_ENUM liblte_mme_pack_authentication_failure_msg(LIBLTE_MME_AUTHENTICATION_FAILURE_MSG_STRUCT* auth_fail, uint8                                 sec_hdr_type,
                                                     uint32                                count,
                                                             LIBLTE_BYTE_MSG_STRUCT*                       msg)
{
  bzero(msg, sizeof(LIBLTE_BYTE_MSG_STRUCT));
...
*********************************************************************/
LIBLTE_ERROR_ENUM liblte_mme_pack_security_mode_reject_msg(LIBLTE_MME_SECURITY_MODE_REJECT_MSG_STRUCT* sec_mode_rej, uint8                                 sec_hdr_type,
                                                     uint32                                count,
                                                           LIBLTE_BYTE_MSG_STRUCT*                     msg)
{
  bzero(msg, sizeof(LIBLTE_BYTE_MSG_STRUCT));
...
*********************************************************************/
LIBLTE_ERROR_ENUM liblte_mme_pack_service_request_msg(LIBLTE_MME_SERVICE_REQUEST_MSG_STRUCT* service_req, uint8                              sec_hdr_type,
                                                        uint32                             count,
                                                      LIBLTE_BYTE_MSG_STRUCT*                msg)
{
  bzero(msg, sizeof(LIBLTE_BYTE_MSG_STRUCT));
  ...
  if (service_req != NULL && msg != NULL) {
    if ((sec_hdr_type != LIBLTE_MME_SECURITY_HDR_TYPE_PLAIN_NAS) && (sec_hdr_type != LIBLTE_MME_SECURITY_HDR_TYPE_SERVICE_REQUEST)) {
      // Protocol Discriminator and Security Header Type
      *msg_ptr = (sec_hdr_type << 4) | (LIBLTE_MME_PD_EPS_MOBILITY_MANAGEMENT);
      msg_ptr++;
    ...
    // Protocol Discriminator and Security Header Type
    // if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_SERVICE_REQUEST) {
...
*********************************************************************/
LIBLTE_ERROR_ENUM
liblte_mme_pack_tracking_area_update_request_msg(LIBLTE_MME_TRACKING_AREA_UPDATE_REQUEST_MSG_STRUCT* ta_update_request,
                                                uint8                                              sec_hdr_type,
                                                uint32                                             count,
                                                LIBLTE_BYTE_MSG_STRUCT*                            msg)
{
  ...
  if (ta_update_request != NULL && msg != NULL) {
    ...
    *msg_ptr = LIBLTE_MME_MSG_TYPE_TRACKING_AREA_UPDATE_REQUEST;
    ...
    // EPS Update Type
    *msg_ptr = 0;
    liblte_mme_pack_eps_update_type_ie(&ta_update_request->eps_update_type, 0, &msg_ptr);
    liblte_mme_pack_nas_key_set_id_ie(&ta_update_request->nas_ksi, 4, &msg_ptr);
    msg_ptr++;
    // EPS Mobile ID
    liblte_mme_pack_eps_mobile_id_ie(&ta_update_request->old_guti, &msg_ptr);
