...
public:
  ...
  std::string get_imsi_a_str() final;
  std::string get_imei_a_str() final;
  std::string get_imsi_tmp_str() final;
  uint32_t get_tmsi_tmp() final;

  bool get_imsi_tmp_vec(uint8_t* imsi_, uint32_t n) final;
  // bool get_tmsi_tmp_vec(uint8_t* guti_, uint32_t n) final;
  bool get_imsi_vec(uint8_t* imsi_, uint32_t n) final;
  bool get_imsi_a_vec(uint8_t* imsi_, uint32_t n) final;
  ...
  bool get_imei_a_vec(uint8_t* imei_, uint32_t n) final;
...
protected:
  ...
  uint64_t    imsi_a = 0;
  uint64_t    imei_a = 0;
  std::string imsi_a_str;
  std::string imei_a_str;
  uint64_t imsi_tmp = 0;
  std::string imsi_tmp_str;
  uint32_t tmsi_tmp = 0;
  // std::string tmsi_tmp_str;
